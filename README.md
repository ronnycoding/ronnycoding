...
- ✍️ **AI Applications**: Automated content creation, Multi-language translation, Content safety validation
...
**💻 Tech:** Remix, Shopify API, Hasura GraphQL, PostgreSQL, Go, Docker
